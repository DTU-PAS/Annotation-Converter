...
def load_annotation_to_img():
    annotation_file = "/home/ronja/data/l515_imgs/RumexLeaves/20200806_stengard/annotations_orig.xml"
    img_path = "/home/ronja/data/l515_imgs/RumexLeaves/20200806_stengard/seq0/imgs/20200806_stengard_rgb_0_1628243852051433086.png"
    ...
    for polyline in annotations.polyline_list:
        points = polyline.get_polyline_points_as_array()
        cv2.polylines(rumex_img, [points], 0, (255, 0, 255), 2)
        for p in points:
            cv2.circle(rumex_img, (p[0], p[1]), 5, (255, 0, 255), -1)
